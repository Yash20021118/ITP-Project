...
const EventList = () => {
  ...
  const generatePDF = async () => {
    ...
    reader.onloadend = function () {
      ...
      // Add background image with lower opacity
      ...
      // Add title and date/time at the top
      doc.setFontSize(18);
      doc.text("Event List", 14, 10);

      doc.setFontSize(12);
      doc.text(`Generated on: ${formattedDate} at ${formattedTime}`, 14, 16);

      // Define table columns and rows
      const tableColumn = ["Id", "Event Name", "Date", "District", "Description"];
      const tableRows = [];
      ...
      // Render the table with event data
      doc.autoTable({
        head: [tableColumn],
        body: tableRows,
        startY: 25, // Start just below the date/time
      });
